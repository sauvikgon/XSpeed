...
hybrid_automata::hybrid_automata(std::map<int, location>& list_locs, location init_loc,
		int dim) {
...
void hybrid_automata::addMapped_Locations_List(std::map<int, location>& mapped_location_list){
