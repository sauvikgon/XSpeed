...
template<> long double approx_comparator<long double>::neg_error_bound =
		-1.0e-20; // -22
template<> long double approx_comparator<long double>::lg_rel_error = 1.0
		+ 1.0e-17; // -15
template<> long double approx_comparator<long double>::sm_rel_error = 1.0
		- 1.0e-17; // -15
