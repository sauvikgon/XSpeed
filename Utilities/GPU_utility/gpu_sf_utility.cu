...
double GPU_W_Support(cublasHandle_t handle,
	...
	double res1 = ReachParameters.time_step
			* system_dynamics.U->computeSupportFunction(trans_dir, lp, lp, //trans_dir used here
					Min_Or_Max);
...
double GPU_Omega_Support(cublasHandle_t handle,
	...
	double res1;
	res1 = Initial_X0->computeSupportFunction(direction, lp, lp_U, Min_Or_Max); //direction used here
	...
	term1 = Initial_X0->computeSupportFunction(r, lp, lp_U, Min_Or_Max); //r used here
	...
	term2 = ReachParameters.time_step
			* system_dynamics.U->computeSupportFunction(trans_dir, lp_U, lp,
					Min_Or_Max); //trans_dir used here
