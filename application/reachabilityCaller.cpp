...
void reachabilityCaller(hybrid_automata& Hybrid_Automata, std::list<initial_state::ptr>& init_state,
	...
	if ((user_options.get_algorithm() == SEQ_SF)
		...
		reach_SEQ_BFS.setReachParameter(Hybrid_Automata, init_state, reach_parameters, lp_solver_type, forbidden_set, user_options);
		...
		agjh reach_AGJH;
		reach_AGJH.setReachParameter(Hybrid_Automata, init_state, reach_parameters, lp_solver_type, forbidden_set, user_options);
		...
		reach.setReachParameter(Hybrid_Automata, init_state, reach_parameters,
				lp_solver_type, forbidden_set, user_options);
