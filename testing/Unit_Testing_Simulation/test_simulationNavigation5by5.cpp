...
TEST_FIXTURE(Example, SimulationTestNAV5x5) {
	...
	x0[0] = 3.3; x0[1] = 3.7; x0[2]=0.1; x0[3]=0.1; x0[4]=0;
...
TEST_FIXTURE(Example, TestManySimulationNAV5x5) {
...
TEST_FIXTURE(Example, TestHaSimulationNAV5x5) {
...
TEST_FIXTURE(Example, ParTestHaSimulationNAV5x5) {
