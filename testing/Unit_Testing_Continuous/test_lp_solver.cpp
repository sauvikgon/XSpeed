...
SUITE(lp_solver_TestSuite) {
	struct ExampleLPSolver {
		ExampleLPSolver() {
	...
	/*
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_TestConstraints_Test) {
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_ComputeLLP_Test) {
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_ComputeLLP_1stQuadrant_Test) {
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_Test_Sequential) {
	 //Test region on the 1stQuadrant
	 row = 4;
	 col = 2;
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_Test_OMP) {
	 //Test region on the 1stQuadrant
	 row = 4;
	 col = 2;
	 ...
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_Testing_a_Problem) {
	 //Test region on the 1stQuadrant
	 row = 4;
	 col = 3;
	...
	/*
	 TEST_FIXTURE(ExampleLPSolver, lp_solver_Test_Sequential_ToCompareWithGurobi) {
	 //Test region on the 1stQuadrant
