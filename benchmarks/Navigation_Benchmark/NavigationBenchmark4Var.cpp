...
// ***********************************************************
	...
	guardBoundValue[0] = 1; // y==2 and 0<=x<=1
	guardBoundValue[1] = 0;
	guardBoundValue[2] = 2;
	guardBoundValue[3] = -2;
	...
	guardBoundValue[0] = 1; // x==1 and 1<=y<=2
	guardBoundValue[1] = -1;
	guardBoundValue[2] = 2;
	guardBoundValue[3] = -1;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 1; // y==1 and 0<=x<=1
	guardBoundValue[1] = 0;
	guardBoundValue[2] = 1;
	guardBoundValue[3] = -1;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 1; // x==1 and 0<=y<=1
	guardBoundValue[1] = -1;
	guardBoundValue[2] = 1;
	guardBoundValue[3] = 0;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 2; // y==1 and 1<=x<=2
	guardBoundValue[1] = -1;
	guardBoundValue[2] = 1;
	guardBoundValue[3] = -1;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 2; // x==2 and 0<=y<=1
	guardBoundValue[1] = -2;
	guardBoundValue[2] = 1;
	guardBoundValue[3] = 0;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 2; // y==2 and 1<=x<=2
	guardBoundValue[1] = -1;
	guardBoundValue[2] = 2;
	guardBoundValue[3] = -2;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 2; // x==2 and 1<=y<=2
	guardBoundValue[1] = -2;
	guardBoundValue[2] = 2;
	guardBoundValue[3] = -1;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 2; // x==2 and 2<=y<=3
	guardBoundValue[1] = -2;
	guardBoundValue[2] = 3;
	guardBoundValue[3] = -2;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 1; // x==1 and 2<=y<=3
	guardBoundValue[1] = -1;
	guardBoundValue[2] = 3;
	guardBoundValue[3] = -2;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 3; // y==2 and 2<=x<=3
	guardBoundValue[1] = -2;
	guardBoundValue[2] = 2;
	guardBoundValue[3] = -2;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
	...
	guardBoundValue[0] = 3; // y==1 and 2<=x<=3
	guardBoundValue[1] = -2;
	guardBoundValue[2] = 1;
	guardBoundValue[3] = -1;
	//guard_polytope.setPolytope(guardConstraintsMatrix, guardBoundValue,guardBoundSign);
...
//  ************ Location ID=1 completed  ************
	...
	location::ptr l4 = location::ptr(
			new location(4, "3", system_dynamics, invariant, true,
...
// The transition label is   t4
	...
	Hybrid_Automata.addInitialLocation(l4);
	Hybrid_Automata.addLocation(l1);
	Hybrid_Automata.addLocation(l2);
	Hybrid_Automata.addLocation(l3);
	Hybrid_Automata.addLocation(l4);
