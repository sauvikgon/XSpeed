...
void set_nav04_timed(hybrid_automata& Hybrid_Automata,
	...
	t = transition::ptr(
			new transition(2, "null", 1, 4, guard_polytope, assignment));

	Out_Going_Trans_fromloc_0.push_back(t);
	l = location::ptr(
			new location(1, "loc_0", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_0));
	...
	t = transition::ptr(
			new transition(3, "null", 2, 1, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(5, "null", 2, 5, guard_polytope, assignment));

	Out_Going_Trans_fromloc_1.push_back(t);
	l = location::ptr(
			new location(2, "loc_1", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_1));
	Hybrid_Automata.addLocation(l);
	...
	l = location::ptr(
			new location(3, "loc_2", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_2));
	Hybrid_Automata.addLocation(l);
	...
	t = transition::ptr(
			new transition(6, "null", 4, 5, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(7, "null", 4, 1, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(8, "null", 4, 7, guard_polytope, assignment));

	Out_Going_Trans_fromloc_3.push_back(t);
	l = location::ptr(
			new location(4, "loc_3", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_3));
	Hybrid_Automata.addLocation(l);
	...
	t = transition::ptr(
			new transition(9, "null", 5, 4, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(10, "null", 5, 6, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(11, "null", 5, 2, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(12, "null", 5, 8, guard_polytope, assignment));

	Out_Going_Trans_fromloc_4.push_back(t);
	l = location::ptr(
			new location(5, "loc_4", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_4));
	Hybrid_Automata.addLocation(l);
...
void Nav04module1(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
	...
	t = transition::ptr(
			new transition(13, "null", 6, 5, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(14, "null", 6, 3, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(15, "null", 6, 9, guard_polytope, assignment));

	Out_Going_Trans_fromloc_5.push_back(t);
	l = location::ptr(
			new location(6, "loc_5", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_5));
	Hybrid_Automata.addLocation(l);

}

void Nav04module2(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
	...
	l = location::ptr(
			new location(7, "loc_6", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_6));
	Hybrid_Automata.addLocation(l);

}

void Nav04module3(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
	...
	t = transition::ptr(
			new transition(16, "null", 8, 7, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(17, "null", 8, 9, guard_polytope, assignment));
	...
	Out_Going_Trans_fromloc_7.push_back(t);
	l = location::ptr(
			new location(8, "loc_7", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_7));
	Hybrid_Automata.addLocation(l);

}

void Nav04module4(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
	...
	t = transition::ptr(
			new transition(19, "null", 9, 8, guard_polytope, assignment));
	...
	t = transition::ptr(
			new transition(20, "null", 9, 6, guard_polytope, assignment));

	Out_Going_Trans_fromloc_8.push_back(t);
	l = location::ptr(
			new location(9, "loc_8", system_dynamics, invariant, true,
					Out_Going_Trans_fromloc_8));
	Hybrid_Automata.addLocation(l);
