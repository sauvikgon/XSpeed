...
void setMotorcar(hybrid_automata& Hybrid_Automata,
	...
	module1MotorCar(Hybrid_Automata, init_state_list, reach_parameters);
	module2MotorCar(Hybrid_Automata, init_state_list, reach_parameters);
	module3MotorCar(Hybrid_Automata, init_state_list, reach_parameters);
	module4MotorCar(Hybrid_Automata, init_state_list, reach_parameters);
...
void module1MotorCar(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void module2MotorCar(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void module3MotorCar(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void module4MotorCar(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
	...
	l = location::ptr(
			new location(6, "GOOD", system_dynamics, invariant, false,
