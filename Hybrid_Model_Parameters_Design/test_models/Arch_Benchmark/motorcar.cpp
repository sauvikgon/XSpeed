...
// Original guard: x_1 - x_2 <= 1
	...
	MCarModule1(Hybrid_Automata, init_state_list, reach_parameters);
	MCarModule2(Hybrid_Automata, init_state_list, reach_parameters);
	MCarModule3(Hybrid_Automata, init_state_list, reach_parameters);
	MCarModule4(Hybrid_Automata, init_state_list, reach_parameters);
...
void MCarModule1(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void MCarModule2(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void MCarModule3(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
...
void MCarModule4(hybrid_automata& Hybrid_Automata,
		std::list<initial_state::ptr>& init_state_list,
		ReachabilityParameters& reach_parameters) {
