...
void SetBilliardModel(hybrid_automata& Hybrid_Automata,
	...
	guardBoundValue[2] = -10.0;
	guardBoundValue[3] = 10.0;
	...
	t = transition::ptr(new transition(1,"wall_y1",1,1,guard_polytope,assignment));
	...
	guardBoundValue[2] = -0.1;
	guardBoundValue[3] = 9.9;
	guard_polytope = polytope::ptr(new polytope(guardConstraintsMatrix, guardBoundValue, guardBoundSign));
	...
	t = transition::ptr(new transition(2,"wall_x2",1,1,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(3,"wall_y2",1,1,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(4,"wall_x1",1,1,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(5,"t1",1,2,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(6,"t2",1,2,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(7,"t3",1,2,guard_polytope,assignment));
	...
	t = transition::ptr(new transition(8,"t4",1,2,guard_polytope,assignment));

	Out_Going_Trans_fromboard.push_back(t);
	l = location::ptr(new location(1, "board", system_dynamics, invariant, true, Out_Going_Trans_fromboard));
	...
	l =location::ptr(new location(2, "GOOD", system_dynamics, invariant, false, Out_Going_Trans_fromGOOD));
	Hybrid_Automata.addLocation(l);
