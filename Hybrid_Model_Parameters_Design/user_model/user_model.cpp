...
void user_model(hybrid_automata& Hybrid_Automata, symbolic_states& initial_symbolic_state, ReachabilityParameters& reach_parameters, int& transition_iterations) {
...
location l2(2, "loc5", system_dynamics1, invariant1, true, Out_Going_Trans_fromloc5);
...
location l3(3, "loc7", system_dynamics2, invariant2, true, Out_Going_Trans_fromloc7);
...
location l4(4, "loc1", system_dynamics3, invariant3, true, Out_Going_Trans_fromloc1);
...
location l5(5, "loc4", system_dynamics4, invariant4, true, Out_Going_Trans_fromloc4);
...
location l6(6, "loc6", system_dynamics5, invariant5, true, Out_Going_Trans_fromloc6);
...
location l7(7, "loc3", system_dynamics6, invariant6, true, Out_Going_Trans_fromloc3);
...
location l9(9, "loc2", system_dynamics8, invariant8, true, Out_Going_Trans_fromloc2);
...
reach_parameters.time_step = reach_parameters.TimeBound / reach_parameters.Iterations;
}
