...
//  ************ Location ID=1 completed  ************
	...
	location l2(2, "1", system_dynamics, invariant, true,
...
void SetNavigationModel4(hybrid_automata& Hybrid_Automata,
	...
	location l1(1, "BAD", system_dynamics0, invariant0, true, Out_Going_Trans_fromloc9);
	...
	location l8(8, "GOOD", system_dynamics7, invariant7, true,Out_Going_Trans_fromloc8);
