...
transition::ptr t1 = transition::ptr(new transition(1,"t6",1,10,guard_polytope0,assignment));
...
transition::ptr t2 = transition::ptr(new transition(2,"t8",1,2,guard_polytope1,assignment));
...
transition::ptr t3 = transition::ptr(new transition(3,"t7",1,4,guard_polytope2,assignment));
...
transition::ptr t4 = transition::ptr(new transition(4,"t20",2,5,guard_polytope3,assignment));
...
transition::ptr t5 = transition::ptr(new transition(5,"t21",2,3,guard_polytope4,assignment));
...
transition::ptr t6 = transition::ptr(new transition(6,"t19",2,1,guard_polytope5,assignment));
...
transition::ptr t7 = transition::ptr(new transition(7,"t18",2,13,guard_polytope6,assignment));
...
location::ptr l3 = location::ptr(new location(3, "BAD", system_dynamics, invariant2, true, Out_Going_Trans_fromBAD));
...
transition::ptr t8 = transition::ptr(new transition(8,"t9",4,1,guard_polytope7,assignment));
...
transition::ptr t9 = transition::ptr(new transition(9,"t11",4,5,guard_polytope8,assignment));
...
transition::ptr t10 = transition::ptr(new transition(10,"t10",4,9,guard_polytope9,assignment));

Out_Going_Trans_fromloc4.push_back(t10);
location::ptr l4 = location::ptr(new location(4, "loc4", system_dynamics, invariant3, true, Out_Going_Trans_fromloc4));
...
transition::ptr t11 = transition::ptr(new transition(11,"t15",5,4,guard_polytope10,assignment));
...
transition::ptr t12 = transition::ptr(new transition(12,"t14",5,2,guard_polytope11,assignment));
...
transition::ptr t13 = transition::ptr(new transition(13,"t17",5,6,guard_polytope12,assignment));
...
transition::ptr t14 = transition::ptr(new transition(14,"t16",5,7,guard_polytope13,assignment));

Out_Going_Trans_fromloc7.push_back(t14);
location::ptr l5 = location::ptr(new location(5, "loc7", system_dynamics, invariant4, true, Out_Going_Trans_fromloc7));
...
transition::ptr t15 = transition::ptr(new transition(15,"t32",6,3,guard_polytope14,assignment));
...
transition::ptr t16 = transition::ptr(new transition(16,"t33",6,5,guard_polytope15,assignment));
...
transition::ptr t17 = transition::ptr(new transition(17,"t34",6,8,guard_polytope16,assignment));
...
transition::ptr t18 = transition::ptr(new transition(18,"t35",6,18,guard_polytope17,assignment));

Out_Going_Trans_fromloc12.push_back(t18);
location::ptr l6 = location::ptr(new location(6, "loc12", system_dynamics, invariant5, true, Out_Going_Trans_fromloc12));
...
location::ptr l7 = location::ptr(new location(7, "GOOD", system_dynamics, invariant6, true, Out_Going_Trans_fromGOOD));
...
transition::ptr t19 = transition::ptr(new transition(19,"t31",8,20,guard_polytope18,assignment));
...
transition::ptr t20 = transition::ptr(new transition(20,"t30",8,7,guard_polytope19,assignment));
...
transition::ptr t21 = transition::ptr(new transition(21,"t29",8,6,guard_polytope20,assignment));

Out_Going_Trans_fromloc11.push_back(t21);
location::ptr l8 = location::ptr(new location(8, "loc11", system_dynamics, invariant7, true, Out_Going_Trans_fromloc11));
...
transition::ptr t22 = transition::ptr(new transition(22,"t13",9,7,guard_polytope21,assignment));
...
transition::ptr t23 = transition::ptr(new transition(23,"t12",9,4,guard_polytope22,assignment));

Out_Going_Trans_fromloc5.push_back(t23);
location::ptr l9 = location::ptr(new location(9, "loc5", system_dynamics, invariant8, true, Out_Going_Trans_fromloc5));
...
transition::ptr t24 = transition::ptr(new transition(24,"t4",10,1,guard_polytope23,assignment));
...
transition::ptr t25 = transition::ptr(new transition(25,"t3",10,11,guard_polytope24,assignment));
...
transition::ptr t26 = transition::ptr(new transition(26,"t5",10,13,guard_polytope25,assignment));

Out_Going_Trans_fromloc2.push_back(t26);
location::ptr l10 = location::ptr(new location(10, "loc2", system_dynamics, invariant9, true, Out_Going_Trans_fromloc2));
...
transition::ptr t27 = transition::ptr(new transition(27,"t1",11,10,guard_polytope26,assignment));
...
transition::ptr t28 = transition::ptr(new transition(28,"t2",11,12,guard_polytope27,assignment));

Out_Going_Trans_fromloc1.push_back(t28);
location::ptr l11 = location::ptr(new location(11, "loc1", system_dynamics, invariant10, true, Out_Going_Trans_fromloc1));
...
transition::ptr t29 = transition::ptr(new transition(29,"t26",12,11,guard_polytope28,assignment));
...
transition::ptr t30 = transition::ptr(new transition(30,"t28",12,14,guard_polytope29,assignment));
...
transition::ptr t31 = transition::ptr(new transition(31,"t27",12,13,guard_polytope30,assignment));

Out_Going_Trans_fromloc10.push_back(t31);
location::ptr l12 = location::ptr(new location(12, "loc10", system_dynamics, invariant11, true, Out_Going_Trans_fromloc10));
...
transition::ptr t32 = transition::ptr(new transition(32,"t23",13,10,guard_polytope31,assignment));
...
transition::ptr t33 = transition::ptr(new transition(33,"t22",13,12,guard_polytope32,assignment));
...
transition::ptr t34 = transition::ptr(new transition(34,"t25",13,15,guard_polytope33,assignment));
...
transition::ptr t35 = transition::ptr(new transition(35,"t24",13,2,guard_polytope34,assignment));

Out_Going_Trans_fromloc9.push_back(t35);
location::ptr l13 = location::ptr(new location(13, "loc9", system_dynamics, invariant12, true, Out_Going_Trans_fromloc9));
...
transition::ptr t36 = transition::ptr(new transition(36,"t40",14,12,guard_polytope35,assignment));
...
transition::ptr t37 = transition::ptr(new transition(37,"t42",14,16,guard_polytope36,assignment));
...
transition::ptr t38 = transition::ptr(new transition(38,"t41",14,15,guard_polytope37,assignment));

Out_Going_Trans_fromloc15.push_back(t38);
location::ptr l14 = location::ptr(new location(14, "loc15", system_dynamics, invariant13, true, Out_Going_Trans_fromloc15));
...
transition::ptr t39 = transition::ptr(new transition(39,"t36",15,14,guard_polytope38,assignment));
...
transition::ptr t40 = transition::ptr(new transition(40,"t37",15,13,guard_polytope39,assignment));
...
transition::ptr t41 = transition::ptr(new transition(41,"t39",15,17,guard_polytope40,assignment));
...
transition::ptr t42 = transition::ptr(new transition(42,"t38",15,3,guard_polytope41,assignment));

Out_Going_Trans_fromloc14.push_back(t42);
location::ptr l15 = location::ptr(new location(15, "loc14", system_dynamics, invariant14, true, Out_Going_Trans_fromloc14));
...
transition::ptr t43 = transition::ptr(new transition(43,"t58",16,14,guard_polytope42,assignment));
...
transition::ptr t44 = transition::ptr(new transition(44,"t60",16,21,guard_polytope43,assignment));
...
transition::ptr t45 = transition::ptr(new transition(45,"t59",16,17,guard_polytope44,assignment));

Out_Going_Trans_fromloc20.push_back(t45);
location::ptr l16 = location::ptr(new location(16, "loc20", system_dynamics, invariant15, true, Out_Going_Trans_fromloc20));
...
transition::ptr t46 = transition::ptr(new transition(46,"t55",17,15,guard_polytope45,assignment));
...
transition::ptr t47 = transition::ptr(new transition(47,"t57",17,22,guard_polytope46,assignment));
...
transition::ptr t48 = transition::ptr(new transition(48,"t54",17,16,guard_polytope47,assignment));
...
transition::ptr t49 = transition::ptr(new transition(49,"t56",17,19,guard_polytope48,assignment));
...
transition::ptr t50 = transition::ptr(new transition(50,"t46",18,19,guard_polytope49,assignment));
...
transition::ptr t51 = transition::ptr(new transition(51,"t49",18,24,guard_polytope50,assignment));
...
transition::ptr t52 = transition::ptr(new transition(52,"t48",18,20,guard_polytope51,assignment));
...
transition::ptr t53 = transition::ptr(new transition(53,"t47",18,6,guard_polytope52,assignment));

Out_Going_Trans_fromloc17.push_back(t53);
location::ptr l18 = location::ptr(new location(18, "loc17", system_dynamics, invariant17, true, Out_Going_Trans_fromloc17));
...
transition::ptr t54 = transition::ptr(new transition(54,"t50",19,17,guard_polytope53,assignment));
...
transition::ptr t55 = transition::ptr(new transition(55,"t51",19,3,guard_polytope54,assignment));
...
transition::ptr t56 = transition::ptr(new transition(56,"t53",19,23,guard_polytope55,assignment));
...
transition::ptr t57 = transition::ptr(new transition(57,"t52",19,18,guard_polytope56,assignment));

Out_Going_Trans_fromloc18.push_back(t57);
location::ptr l19 = location::ptr(new location(19, "loc18", system_dynamics, invariant18, true, Out_Going_Trans_fromloc18));
...
transition::ptr t58 = transition::ptr(new transition(58,"t43",20,18,guard_polytope57,assignment));
...
transition::ptr t59 = transition::ptr(new transition(59,"t45",20,25,guard_polytope58,assignment));
...
transition::ptr t60 = transition::ptr(new transition(60,"t44",20,8,guard_polytope59,assignment));

Out_Going_Trans_fromloc16.push_back(t60);
location::ptr l20 = location::ptr(new location(20, "loc16", system_dynamics, invariant19, true, Out_Going_Trans_fromloc16));
...
transition::ptr t61 = transition::ptr(new transition(61,"t72",21,16,guard_polytope60,assignment));
...
transition::ptr t62 = transition::ptr(new transition(62,"t73",21,22,guard_polytope61,assignment));
...
transition::ptr t63 = transition::ptr(new transition(63,"t70",22,17,guard_polytope62,assignment));
...
transition::ptr t64 = transition::ptr(new transition(64,"t69",22,21,guard_polytope63,assignment));
...
transition::ptr t65 = transition::ptr(new transition(65,"t71",22,23,guard_polytope64,assignment));
...
transition::ptr t66 = transition::ptr(new transition(66,"t66",23,22,guard_polytope65,assignment));
...
transition::ptr t67 = transition::ptr(new transition(67,"t67",23,19,guard_polytope66,assignment));
...
transition::ptr t68 = transition::ptr(new transition(68,"t68",23,24,guard_polytope67,assignment));
...
transition::ptr t69 = transition::ptr(new transition(69,"t63",24,23,guard_polytope68,assignment));
...
transition::ptr t70 = transition::ptr(new transition(70,"t65",24,25,guard_polytope69,assignment));
...
transition::ptr t71 = transition::ptr(new transition(71,"t64",24,18,guard_polytope70,assignment));
...
transition::ptr t72 = transition::ptr(new transition(72,"t61",25,24,guard_polytope71,assignment));
...
transition::ptr t73 = transition::ptr(new transition(73,"t62",25,20,guard_polytope72,assignment));
